  ...
  return (
    <section className="coarse-map" aria-labelledby="coarse-map-title">
      <div className="coarse-map-copy">
        <span className="eyebrow">Ward pulse</span>
        <h2 id="coarse-map-title">Where records are gathering</h2>
      ...
      <div className="map-canvas" aria-label={`${visible.length} approximate civic issue locations`}>
        <span className="map-district-label label-one">Kathmandu</span>
        <span className="map-district-label label-two">Lalitpur</span>
        <span className="map-district-label label-three">Bhaktapur</span>
